...
output_path = f'{xp_name}/results/mcappo_16_channels.p'
...
for seed in range(n_seeds):
    ...
    for load in loads_list:
        ...
        model_folder = f"models_mcappo{n_channels}_seed_{seed}_load_{load}"
...
ppo_result = {"scores": ppo_scores_list,
                ...
                "xp_params": {'loads': loads_list, 'deadlines': 7},
